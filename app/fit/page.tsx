...
import styles from "../../components/FitWidget.module.css";

// Font Awesome
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {faArrowUpRightFromSquare, faCircleCheck, faFileLines, faRotateLeft, faShield, faSpinner, faTriangleExclamation, faUpload, faWandMagicSparkles} from "@fortawesome/free-solid-svg-icons";
...
export default function FitWidget() {
    ...
    async function onSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            setLoading(false);
            setCaptcha(null); // token is single-use; request a fresh one
        }
    }
